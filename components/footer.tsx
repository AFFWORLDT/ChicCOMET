          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <div className="space-y-3 mb-4 text-xs sm:text-sm text-[#404040]">
              ...
              <p className="flex items-center text-black">
                ...
                <a href="mailto:info@chiccomet.com" className="text-black hover:text-primary transition-colors">info@chiccomet.com</a>
              </p>
            </div>
            ...
            <div className="flex flex-wrap gap-2">
              <a
                href="https://www.instagram.com/chiccomet"
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href="https://www.threads.com/@chiccomet"
                target="_blank"
                rel="noopener noreferrer"
                className="text-black hover:text-primary transition-all duration-300"
              ...
              <a
                href="https://www.youtube.com/@chiccomet"
                target="_blank"
                rel="noopener noreferrer"
                className="text-black hover:text-primary transition-all duration-300"
              ...
              <a
                href="https://www.facebook.com/chiccomet/"
                target="_blank"
                rel="noopener noreferrer"
                className="text-black hover:text-primary transition-all duration-300"
